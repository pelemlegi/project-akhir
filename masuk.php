                    ...
                    <div class="flex flex-1 flex-col md:flex-row lg:flex-row mx-2">
                        ...
                        <div class="rounded overflow-hidden shadow bg-white mx-2 w-full">
                            <div class="px-6 py-2 border-b border-light-grey">
                                <div class="font-bold text-xl">Peralatan Masuk</div>
								<div class="p-3">
    ...
    <div class="modal modal-centered">
        <div class="modal-content shadow-lg p-5">
            ...
            <form method = "post" id='form_id' class="w-full">
                ...
                <div class="mt-5">
                    <button class='bg-green-500 hover:bg-green-800 text-white font-bold py-2 px-4 rounded' name = "barangmasuk"> Serahkan </button>
